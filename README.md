...
## Frontend Architecture & Local Development (Angular)
The user interface is a dynamic, multi-module Angular application designed for a seamless, interactive user experience. This project was generated using [Angular CLI](https://github.com/angular/angular-cli) version 21.0.5.

### Development server
To start a local development server for the UI, run:
```bash
ng serve